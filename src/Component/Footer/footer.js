...
const Footer = () => {
  return (
    <footer class="pv4 ph3 ph5-ns tc bt">
      <a
      ...
      <a
        className="f4 fw6 db black link hover-dark-blue"
        href="https://icons8.com/icon/74792/blockchain-new-logo"
      >
        Blockchain New Logo icon by Icons8
      </a>
    </footer>
  );
};
